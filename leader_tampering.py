...
class LeaderTamper(object):
    ...
    def __init__(self):
        ...
        self.mqtt_client.will_set(self.mqtt_topic, '_____Will of LeaderTamper ____\n\n', 0, False)
        ...
        if len(tokens) == 3:
            ...
            if msg == 'send_leader':
                if not self.currentLeader:
                    self.currentLeader = payload
                elif payload != self.currentLeader:
